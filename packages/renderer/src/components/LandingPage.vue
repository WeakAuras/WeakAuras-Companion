        ...
        <template v-if="configStep === 0">
          ...
          <div id="dashboard">
            ...
            <template v-if="aurasSortedForView.length > 0">
              ...
              <div id="aura-list">
                <Aura v-for="aura in aurasSortedForView" :key="aura.slug" :aura="aura" :show-all-auras="config.showAllAuras"></Aura>
              </div>
            </template>
          </div>
        </template>
