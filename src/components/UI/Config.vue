  ...
  <div id="config">
    <div class="config-row">
      <div class="config-row-item">
        ...
        <div class="block">
          <file-select v-model:path="config.wowpath.value" :default-path="defaultWOWPath"
            @update:path="$parent.validateWowpath" openDirectory="true" createDirectory="true">
      ...
      <div class="config-row-item">
        ...
        <div class="block">
          ...
          <div v-if="config.backup.active" style="display: inline">
            <file-select v-model:path="config.backup.path" :default-path="config.backup.defaultBackupPath"
              openDirectory="true" createDirectory="true">
            ...
            <Dropdown v-model:value="config.backup.maxsize" :options="backupsize"
